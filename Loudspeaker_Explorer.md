...
Note that the following speakers, despite having been measured by amirm, are not (yet) available in this tool:
 ...
 - [**Magnepan LRS (no offset)**](https://www.audiosciencereview.com/forum/index.php?threads/magnepan-lrs-speaker-review.16068/): the raw data was not published. The data shown here is from the vertically offset measurement.
